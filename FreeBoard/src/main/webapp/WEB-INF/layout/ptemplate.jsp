...
<body>
    ...
    <div class="humberger__menu__wrapper">
        ...
        <nav class="humberger__menu__nav mobile-menu">
            <ul>
                <li class="active"><a href="pmain.do">Home</a></li>
                <li><a href="./shop-grid.html">Shop</a></li>
                <li><a href="#">Pages</a>
                    <ul class="header__menu__dropdown">
                        <li><a href="./shop-details.html">Shop Details22</a></li>
                        <li><a href="pmain.do?p=pcart">Shoping Cart</a></li>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <nav class="header__menu">
                        <ul>
                            <li class="active"><a href="pmain.do">Home</a></li>
                            <li><a href="pmain.do?p=plist">Shop</a></li>
                            <li><a href="#">Pages</a>
                                <ul class="header__menu__dropdown">
